  ...
  <div class="pending-approval-view">
    <div class="page-header">
      <div class="header-left">
        <h2>待审批</h2>
        <span class="subtitle">共 {{ pagination.total }} 条待审批</span>
      </div>
    </div>
        ...
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6">
            <el-form-item label="紧急程度">
              <el-select v-model="searchForm.urgency" placeholder="请选择" clearable size="large" style="width: 100%;">
                <el-option label="全部" value="" />
    ...
    <el-card shadow="never" class="table-card">
      ...
      <el-table :data="approvals" style="width: 100%" v-loading="loading" @selection-change="handleSelectionChange" stripe border>
        ...
        <el-table-column label="紧急程度" width="100" align="center">
          <template #default="{ row }">
            <el-tag :type="row.urgency === '紧急' ? 'danger' : 'info'" size="small">{{ row.urgency }}</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200" fixed="right" align="center">
          <template #default>
            ...
            <el-button link type="success" size="small" :icon="CircleCheck">通过</el-button>
...
const approvals = ref([
  { id: 1, approvalNo: 'AP202511280001', type: '请假申请', applicant: '张三', department: '厨房部', content: '因病请假2天', urgency: '普通', applyTime: '2025-11-28 09:00' },
  { id: 2, approvalNo: 'AP202511280002', type: '加班申请', applicant: '李四', department: '服务部', content: '周末活动加班8小时', urgency: '紧急', applyTime: '2025-11-28 08:45' },
  { id: 3, approvalNo: 'AP202511280003', type: '采购申请', applicant: '王五', department: '采购部', content: '紧急采购食材', urgency: '紧急', applyTime: '2025-11-28 08:30' },
  { id: 4, approvalNo: 'AP202511280004', type: '报销申请', applicant: '赵六', department: '管理部', content: '差旅费报销', urgency: '普通', applyTime: '2025-11-28 08:15' },
  { id: 5, approvalNo: 'AP202511280005', type: '请假申请', applicant: '孙七', department: '厨房部', content: '家中有事请假1天', urgency: '普通', applyTime: '2025-11-27 16:30' },
  { id: 6, approvalNo: 'AP202511280006', type: '加班申请', applicant: '周八', department: '服务部', content: '工作日加班3小时', urgency: '普通', applyTime: '2025-11-27 15:45' },
  { id: 7, approvalNo: 'AP202511280007', type: '采购申请', applicant: '吴九', department: '采购部', content: '月度食材采购', urgency: '普通', applyTime: '2025-11-27 15:00' },
  { id: 8, approvalNo: 'AP202511280008', type: '报销申请', applicant: '郑十', department: '管理部', content: '办公用品采购报销', urgency: '普通', applyTime: '2025-11-27 14:30' },
  { id: 9, approvalNo: 'AP202511280009', type: '请假申请', applicant: '钱一', department: '厨房部', content: '年假申请5天', urgency: '普通', applyTime: '2025-11-27 14:00' },
  { id: 10, approvalNo: 'AP202511280010', type: '加班申请', applicant: '陈二', department: '服务部', content: '活动准备加班', urgency: '紧急', applyTime: '2025-11-27 13:30' }
])
